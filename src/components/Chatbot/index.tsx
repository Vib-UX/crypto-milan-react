...
const events = ['Unfold', 'ETHIndia', 'CoinDCX'];
        ...
        <div className="fixed bottom-4 right-4 z-50">
            {!isOpen && (
                <button
                    ...
                    className="bg-zinc-800 text-white p-4 rounded-full shadow-lg hover:bg-zinc-700 transition-colors"
                >
                    <MessageCircle size={24} />
                </button>
            )}
            {isOpen && (
                <div className="bg-zinc-900 rounded-lg shadow-xl flex flex-col w-[340px] h-[500px] max-h-[calc(100vh-2rem)]">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            ...
                            <button
                                type="submit"
                                className="p-2 bg-orange-600 text-white rounded-lg hover:bg-orange-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                            >
